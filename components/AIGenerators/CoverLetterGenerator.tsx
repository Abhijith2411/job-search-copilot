...
export function CoverLetterGenerator({ job, onClose }: GeneratorProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-slate-800 border border-slate-700 rounded p-4">
        <h3 className="font-semibold text-white mb-3">Tone</h3>
        <select
          value={tone}
      ...
      {output && (
        <div className="bg-slate-800 border border-slate-700 rounded p-4">
          ...
          <textarea
            value={output}
            readOnly
            className="w-full h-48 p-3 bg-slate-950 border border-slate-600 rounded text-white text-sm"
          />
        </div>
      )}
